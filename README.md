...
|아이디와 비밀번호를 입력하여 로그인합니다.<br> 운동을 선택하고 '교정 시작하기' 버튼을 누릅니다.|사용자의 포즈를 확인하고 '내려갑니다!' 알림 확인 후 운동을 1회 실시합니다.|AI 피드백 생성을 위해 잠시 기다립니다.<br> 사용자가 대기시간 동안 지루할 수 있으므로 이미지와 운동 팁을 보여줍니다.|AI를 통해 생성된 피드백 영상과 텍스트를 확인합니다.|피드백 메뉴로 이동하여 누적된 피드백 리스트를 확인하고 확인하려는 회차의 피드백을 선택합니다.|AI 피드백 결과로 'inward' 상태인 모습을 확인할 수 있습니다. 교정을 위해 영상과 텍스트를 참고합니다.|AI 피드백 결과로 'shallow' 상태인 모습을 확인할 수 있습니다. 교정을 위해 영상과 텍스트를 참고합니다.|
